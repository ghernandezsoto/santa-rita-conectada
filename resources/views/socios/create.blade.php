                    ...
                    <form method="POST" action="{{ route('socios.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="profesion" class="block mt-1 w-full" type="text" name="profesion" :value="old('profesion')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="estado_civil" class="block mt-1 w-full" type="text" name="estado_civil" :value="old('estado_civil')" />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="observaciones" name="observaciones" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('observaciones') }}</textarea>
