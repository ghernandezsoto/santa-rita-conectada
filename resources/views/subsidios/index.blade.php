<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('subsidios.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                                    ...
                                    <tr class="border-b hover:bg-gray-50">
                                        ...
                                        <td class="py-3 px-4">
                                            <span class="py-1 px-3 rounded-full text-xs font-semibold
                                                @if($subsidio->estado == 'Aprobado') bg-green-200 text-green-800 @endif
                                                @if($subsidio->estado == 'Rechazado') bg-red-200 text-red-800 @endif
                                                @if($subsidio->estado == 'Postulando') bg-yellow-200 text-yellow-800 @endif
                                                @if($subsidio->estado == 'Finalizado') bg-blue-200 text-blue-800 @endif
                                            ">
                                                {{ $subsidio->estado }}
                                            </span>
                                        </td>
