<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{-- El título cambia dependiendo del tipo de transacción --}}
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('transacciones.store') }}">
                        @csrf
                        {{-- Campo oculto para enviar el tipo de transacción --}}
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="monto" class="block mt-1 w-full" type="number" name="monto" :value="old('monto')" required step="0.01" />
