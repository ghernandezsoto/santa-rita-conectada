        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6">
                ...
                <div class="bg-white p-5 sm:p-6 rounded-lg shadow-md">
                    ...
                    <p class="text-2xl sm:text-3xl font-bold mt-2 {{ $balance >= 0 ? 'text-success-600' : 'text-gray-800' }} tabular-nums">
                            ...
                            <table class="min-w-full bg-white table-fixed" role="table" aria-label="Tabla de transacciones">
                                <thead class="bg-primary-800 text-white">
                                    <tr>
                                        ...
                                        <th scope="col" class="py-3 px-4 font-semibold text-sm text-center w-[8%]">Acciones</th>
                                    </tr>
                                </thead>
                                <tbody class="text-gray-700">
                                    @forelse ($transacciones as $transaccion)
                                        <tr class="border-b hover:bg-base-50">
                                            <td class="py-3 px-4 whitespace-nowrap">{{ $transaccion->fecha->format('d/m/Y') }}</td>
                                            ...
                                            <td class="py-3 px-4">
                                                ...
                                                <div class="flex items-center justify-center gap-4">
                                                    ...
                                                    <form action="{{ route('transacciones.destroy', $transaccion->id) }}" method="POST" onsubmit="return confirm('¿Estás seguro de que quieres eliminar esta transacción?')">
                                                        @csrf
                                                        @method('DELETE')
                        ...
                        @forelse ($transacciones as $transaccion)
                            <article class="bg-white border rounded-lg p-4 shadow-sm">
                                <div class="flex items-start justify-between gap-3">
                                    <div class="min-w-0">
                                        <p class="text-sm font-semibold">{{ $transaccion->fecha->format('d/m/Y') }}</p>
